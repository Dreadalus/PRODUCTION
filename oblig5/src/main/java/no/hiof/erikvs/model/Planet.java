...
public class Planet extends NaturalSatellite {
    ...
    // constructor
    public Planet(/*int solarOrder, */String name, double radius, double mass, double semiMajorAxis, double eccentricity, double orbitalPeriod, String pictureUrl, CelestialBody centralCelestialBody) {
