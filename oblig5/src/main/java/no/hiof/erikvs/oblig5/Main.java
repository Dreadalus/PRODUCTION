...
import no.hiof.erikvs.oblig5.model.Star;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= 180; i += 45) {
            double distance = earth.distanceToCentralBody(i);
            double velocity = earth.orbitingVelocityInMeterPerSecond(distance);
            System.out.printf("At a distance of %.0fkm, %s has a velocity of %.2fm/s%n", distance, earth.getName(), velocity);
        }
